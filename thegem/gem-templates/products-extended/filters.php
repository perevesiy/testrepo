			...
			<div class="portfolio-filters-area <?php if (isset($params['filter_buttons_hidden_sidebar_overlay_shadow']) && $params['filter_buttons_hidden_sidebar_overlay_shadow'] == '1') {
				...
				<div class="portfolio-filters-area-scrollable">
					...
					<div class="page-sidebar widget-area" role="complementary">
						...
						<?php } ?>
						<?php if ($params['filter_by_categories'] == '1' && count($terms) > 0) { ?>
						...
						<?php if ($params['filter_by_attribute'] == '1') {
										...
										<div class="portfolio-filter-item attribute <?php echo esc_attr($item['attribute_name']) . ' '; ?><?php echo strtolower($item['attribute_query_type']) == 'and' ? 'multiple' : 'single'; ?><?php echo esc_attr($attribute_type_class); ?>">
											...
											<div class="portfolio-filter-item-list">
												<ul>
													...
													<?php
													if ($params['filter_by_attribute_hide_null'] == '1') {
														$empty_params = array();
													} else {
														$empty_params = array(
															'hide_empty' => false,
						...
						<?php if ($params['filter_by_status'] == '1') { ?>
