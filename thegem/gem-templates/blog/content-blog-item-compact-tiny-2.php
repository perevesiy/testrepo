	...
	<div class="gem-compact-tiny-right">
		<div class="gem-compact-item-content">
			<?php if ($params['show_title']) {
				...
				$color_class = '';
				if ($params['title_preset2'] !== 'main-menu-item') {
