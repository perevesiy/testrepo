 ...
 */
$title = $source = $image = $custom_src = $onclick = $img_size = $external_img_size = $caption = $img_link_large = $link = $img_link_target = '';
$alignment = $el_class = $el_id = $css_animation = $style = $external_style = $border_color = $css = '';
...
$output = '
	...
	<div ' . implode( ' ', $wrapper_attributes ) . ' class="' . esc_attr( trim( $css_class ) ) . '" '.$styles.'>
