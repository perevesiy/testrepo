...
/*        $type = 'term';
    ...
    function optimizerWPRocketActivate($request) {
        ...
        if ($res !== NULL) {
            return array('message' => __('Activation of WP Rocket plugin failed, please use "Reinstall" button to reinstall and reactivate this plugin.', 'thegem'));
        }

        $res = activate_plugin('wp-rocket-disable-google-font-optimization/wp-rocket-disable-google-font-optimization.php');

        if ($res !== NULL) {
            return array('message' => __('Activation of "WP Rocket disable google font optimization" plugin failed, please use "Reinstall" button to reinstall and reactivate this plugin.', 'thegem'));
        }
    ...
    function optimizerAutoptimizeActivate($request) {
        ...
        if ($res !== NULL) {
            return array('message' => __('Activation of Autoptimize plugin failed, please use "Reinstall" button to reinstall and reactivate this plugin.', 'thegem'));
        }
    ...
    function addAppData($specificData) {
        ...
        $appData=array_merge( array(
            ...
            'titleTemplateCreateUrl' => admin_url('edit.php?post_type=thegem_templates&templates_type=title#open-modal'),
            'footerTemplateCreateUrl' => admin_url('edit.php?post_type=thegem_templates&templates_type=footer#open-modal'),
    ...
    function getOptimizerInfo() {
        $data = array();
        $data['activated'] = get_option('thegem_enabled_wprocket_autoptimize');
        if (!$data['activated']) {
