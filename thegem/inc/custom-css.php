...
:root {
    --thegem-to-title-h5-font-family: '<?php echo thegem_get_option('h5_font_family'); ?>';
}
h5,
.gem-table thead th,
.title-h5,
...
:root {
    ...
    --thegem-to-title-h5-font-weight: <?php echo str_replace(array('italic', 'normal', 'regular', 'oblique'),array('', '', 'normal', ''),thegem_get_option('h5_font_style')); ?>;
}
h5,
.title-h5,
.header-layout-overlay #primary-menu.no-responsive > li.menu-item-search > .minisearch input[type="text"],
...
:root {
    --thegem-to-title-h5-font-style: italic;
}
h5,
.title-h5,
.header-layout-overlay #primary-menu.no-responsive > li.menu-item-search > .minisearch input[type="text"],
...
:root {
    --thegem-to-title-h5-font-style: oblique;
}
h5,
.title-h5,
.header-layout-overlay #primary-menu.no-responsive > li.menu-item-search > .minisearch input[type="text"],
...
:root {
    --thegem-to-title-h5-font-size: <?php echo thegem_get_option('h5_font_size'); ?>px;
}
h5,
.title-h5,
.header-layout-overlay #primary-menu.no-responsive > li.menu-item-search > .minisearch input[type="text"],
...
:root {
    --thegem-to-title-h5-line-height: <?php echo thegem_get_option('h5_line_height'); ?>px;
}
h5,
.title-h5,
.gem-teams-phone,
...
<?php if(thegem_get_option('product_grid_title_line_height')) : ?>
	...
	max-height: calc(<?php echo thegem_get_option('product_grid_title_line_height'); ?>px * 2);
	}
	@media (min-width: 992px) {
		.portfolio.extended-products-grid .portfolio-item.bigger .caption .title {
		line-height: calc(<?php echo thegem_get_option('product_grid_title_line_height'); ?>px * 1.7);
		max-height: calc(<?php echo thegem_get_option('product_grid_title_line_height'); ?>px * 3.4);
		}
	}
<?php endif; ?>
