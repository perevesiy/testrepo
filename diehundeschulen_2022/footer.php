		...
		<?php if (!$effects_params['effects_hide_footer']) : ?>
			...
			<?php
				if ($header_params['footer_custom'] && $header_params['footer_custom_show']) {
					...
					$thegem_q = new WP_Query(array('p' => $header_params['footer_custom'], 'post_type' => array('thegem_footer', 'thegem_templates'), 'post_status' => 'private'));
				}
			...
			<?php if(!$header_params['footer_hide_default'] && 11!==11) : ?>
...
wp_footer(); 
//die();
        //get_template_part('partials/test-footer');
